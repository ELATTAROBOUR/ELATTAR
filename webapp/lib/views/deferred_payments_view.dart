                ...
                onPressed: () async {
                  ...
                  if (name.isEmpty || phone.isEmpty || total <= 0) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text('⚠️ يرجى تعبئة الحقول الأساسية المطلوبة'),
                      ),
                    );
                    return;
                  }
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setDialogState) {
          ...
          return AlertDialog(
            ...
            title: Text(
              '💰 كشف سداد الحساب: ${dp.customerName}',
              style: TextStyle(
                color: primaryGold,
                fontWeight: FontWeight.bold,
                fontSize: 20,
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          'المطلوب: ${dp.totalAmount} ج.م',
                          style: TextStyle(color: textColor, fontSize: 14),
                        ),
                        Text(
                          'المدفوع: ${dp.paidAmount} ج.م',
                          style: TextStyle(
                        ...
                        Text(
                          'المتبقي: ${dp.remainingAmount} ج.م',
                          style: TextStyle(
                  ...
                  Expanded(
                    child: isHistLoading
                        ...
                        ? Center(
                            child: Text(
                              'لا توجد سحوبات/دفعات مسجلة مسبقاً',
            ...
            return pw.Directionality(
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  pw.Text(
                    'كشف حساب مديونيات العميل الآجل',
                    style: pw.TextStyle(
                      fontSize: 11,
                      fontWeight: pw.FontWeight.bold,
                    ),
                  ...
                  pw.Text(
                    'العطار استور - تقرير حسابات الديون الموثق',
                    style: pw.TextStyle(
                      fontSize: 8,
                      fontWeight: pw.FontWeight.bold,
                    ),
                ...
                ? Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 16),
                        Text(
                          'لا توجد مديونيات آجلة مسجلة للعملاء حالياً',
