            ...
            return pw.Directionality(
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  pw.Text(
                    'شكراً لثقتكم بنا - نظام العطار استور',
                    style: pw.TextStyle(
                      fontSize: 8,
                      fontWeight: pw.FontWeight.bold,
                    ),
  ...
  Future<void> _submitTransfer() async {
    ...
    if (qty <= 0) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text('⚠️ يرجى إدخال كمية صحيحة')));
      return;
    }
    ...
    if (sourceWarehouse == _toWarehouse) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('⚠️ لا يمكن التحويل لنفس المخزن الحالي')),
      );
      return;
    }
