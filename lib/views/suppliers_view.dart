  ...
  void _showAddSupplierDialog() {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: const Text('➕ إضافة مورد جديد بالنظام',
            style: TextStyle(
        ...
        content: Column(
          ...
          children: [
            TextField(
              ...
              decoration:
                  const InputDecoration(labelText: 'اسم الشركة / المورد *'),
            ),
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setDialogState) {
          ...
          return AlertDialog(
            ...
            title: Text('➕ تسجيل مديونية مورد يدوياً',
                style: TextStyle(
                    color: primaryGold,
                    fontWeight: FontWeight.bold,
                    fontSize: 20)),
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setDialogState) {
          ...
          return AlertDialog(
            ...
            shape:
                RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
            title: Text('💸 سداد دفعات للمورد: ${sd.supplierName}',
                style: TextStyle(
                    color: primaryGold,
                    fontWeight: FontWeight.bold,
                    fontSize: 20)),
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text('الفاتورة: ${sd.totalAmount} ج.م',
                            style: TextStyle(color: textColor, fontSize: 14)),
                        Text('المسدد: ${sd.paidAmount} ج.م',
                            style: TextStyle(
                                color: Colors.greenAccent,
                                fontSize: 14,
                                fontWeight: FontWeight.bold)),
                        Text('المتبقي للمورد: ${sd.remainingAmount} ج.م',
                            style: TextStyle(
                  ...
                  // History list
                  Text('سجل سداد المدفوعات للمورد:',
                      style: TextStyle(
                          color: textColor,
                          fontWeight: FontWeight.bold,
                          fontSize: 15)),
            ...
            return pw.Directionality(
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  pw.Text('كشف حساب مستحقات المورد',
                      style: pw.TextStyle(
                  ...
                  _receiptRowHelper('حالة الفاتورة',
                      sd.remainingAmount == 0 ? 'مسددة بالكامل' : 'قيد السداد'),
                  pw.SizedBox(height: 4),
                  pw.Divider(thickness: 0.5),
                  pw.SizedBox(height: 4),
                  _receiptRowHelper('إجمالي الفاتورة',
                      '${sd.totalAmount.toStringAsFixed(2)} ج.م'),
                  _receiptRowHelper('المسدد للمورد',
                      '${sd.paidAmount.toStringAsFixed(2)} ج.م'),
                  _receiptRowHelper('المتبقي للمورد',
                  ...
                  pw.Divider(thickness: 0.5),
                  pw.SizedBox(height: 4),
                  pw.Text('تفاصيل التحصيل والسداد للمورد:',
                      style: pw.TextStyle(
                  ...
                  pw.Text('العطار استور - تقرير مستحقات الموردين المالي',
                      style: pw.TextStyle(
                          fontSize: 8, fontWeight: pw.FontWeight.bold),
                      textAlign: pw.TextAlign.center),
              ...
              Row(
                children: [
                  ...
                  ElevatedButton.icon(
                    ...
                    label: const Text('تسجيل دين مورد يدوياً',
                        style: TextStyle(
                            fontWeight: FontWeight.bold, fontSize: 16)),
                  ),
                ],
