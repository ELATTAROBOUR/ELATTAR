      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setDialogState) {
          ...
          return AlertDialog(
            ...
            title: Text('🏢 إدارة المخازن والفروع',
                style: TextStyle(
                    color: primaryGold,
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setDialogState) {
          ...
          return AlertDialog(
            ...
            shape:
                RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
            title: Text('📊 بدء جرد المخزن المادي',
                style: TextStyle(
                    color: primaryGold,
                    fontWeight: FontWeight.bold,
                    fontSize: 20)),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      style: TextStyle(color: textColor, fontSize: 16),
                      decoration:
                          const InputDecoration(labelText: 'نوع الصنف *'),
                      items: const [
                        DropdownMenuItem(
                            value: 'accessory', child: Text('إكسسوار')),
                        DropdownMenuItem(value: 'device', child: Text('جهاز')),
                        DropdownMenuItem(
                            value: 'spare_part', child: Text('قطعة غيار')),
                      ],
                      onChanged: (val) {
                        selectedType = val!;
                        updateItemsList(selectedType, setDialogState);
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('الكمية المسجلة بالنظام:',
                              style: TextStyle(
                                  color: AppTheme.textMuted(context),
                                  fontSize: 15)),
                          Text(expectedQty.toString(),
                              style: TextStyle(
                                  color: textColor,
                                  fontWeight: FontWeight.bold,
                                  fontSize: 18)),
                ...
                onPressed: () async {
                  ...
                  if (context.mounted) {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content:
                            Text('✅ تم حفظ الجرد وتحديث المخزن. الفرق: $diff'),
                        backgroundColor: Colors.green,
                      ),
                    );
                  }
                },
                child: const Text('حفظ وتحديث المخزن',
            ...
            return pw.Directionality(
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  pw.Text('تقرير كشف جرد بضاعة المخزن',
                      style: pw.TextStyle(
                          fontSize: 11, fontWeight: pw.FontWeight.bold),
                      textAlign: pw.TextAlign.center),
                  pw.Text('تاريخ الجرد: $dateStr',
                  ...
                  pw.Text('العطار استور - نظام جرد البضائع الذكي',
                      style: pw.TextStyle(
                          fontSize: 8, fontWeight: pw.FontWeight.bold),
                      textAlign: pw.TextAlign.center),
              ...
              Row(
                children: [
                  ElevatedButton.icon(
                    ...
                    label: const Text('إدارة المخازن',
                        style: TextStyle(
                  ...
                  ElevatedButton.icon(
                    ...
                    label: const Text('بدء عملية الجرد',
                        style: TextStyle(
                            fontWeight: FontWeight.bold, fontSize: 16)),
                  ),
                  const SizedBox(width: 12),
